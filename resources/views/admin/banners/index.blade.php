    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-10 overflow-auto">
                ...
                @if ($banners->isEmpty())
                    <h4 style="text-align: center">No Banners Found....</h4>
                @else
                <table class="w-100 bg-white text-center" id="table-list">
                    ...
                    <tr>
                        ...
                        <td class="py-3 px-1">{{Str::limit($banner->description,40)}}</td>
                        <td class="py-3 px-1">
                            <a type="button" href="{{url('admin/edit-banner/'.$banner->id)}}" class="btn btn-success mb-1">Edit</a>
