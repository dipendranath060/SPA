...
<section class="testimonial-list">
    <div class="container">
        <h2 class="mb-5 section-title border-bottom pb-3 text-center">Testimonial List</h2>
        <div class="row justify-content-center">
            ...
            <div class="col-lg-10 overflow-auto">
                <div class="text-end mb-3">
                    <a href="{{route('add-testimonial')}}" class="btn btn-success">+ Add New Testimonial</a>
                </div>
                @if($testimonials->isEmpty())
                    <h4 style="text-align: center">Testimonials Not Found...</h4>
                @else 
                <table class="w-100 bg-white text-center" id="table-list">
                    ...
                    <tr>
                        ...
                        <td class="py-3 px-1">{{$testimonial->title}}</td>
                        <td>
                            <img src="{{asset('uploads/testimonials/'.$testimonial->image)}}" width="80px" alt="img">
                        </td>
                        <td class="py-3 px-1">{{Str::limit($testimonial->description,40)}}</td>
                        <td class="py-3 px-1">
                            <a type="button" href="{{url('admin/edit-testimonial/'.$testimonial->id)}}" class="btn btn-success mb-1">Edit</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form id="deleteTestimonialForm" action="{{ url('admin/delete-testimonial/'.$testimonial->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
