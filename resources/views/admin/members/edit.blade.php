          ...
          <div class="row mb-3 justify-content-center">
            <div class="col-lg-7">
              <div class="add-form bg-white p-4 rounded">
                ...
                @endif
                <form action="{{url('admin/update-member/' .$team->id)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <div class="mb-3">
                    <label for="title" class="fs-5 mb-2">Name</label>
                    <input type="text" value="{{$team->name}}" name="name" id="title" class="w-100" required />
                  </div>
                  <div class="mb-3">
                    <label for="title" class="fs-5 mb-2">Post</label>
                    <input type="text" value="{{$team->post}}" name="post" id="post" class="w-100" required />
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input
                      ...
                      value="{{$team->image}}"
                    ></input><br><br>
                    <img src="{{asset('uploads/members/'.$team->image)}}" width="100px" alt="existing image">
                  </div>
                  ...
                  <button type="submit" class="btn btn-primary mb-1">Update Member</button>
                  <button
